...
import kamer.Cameroon.reader.mycomponent.MyStreamReaderImpl
import kamer.Cameroon.transformer.mycomponent.MyStreamTransformerImpl
import kamer.Cameroon.writer.mycomponent.MyStreamWriterImpl
